...
partial class AddProductItemForm
{
    /// <summary>
    ...
    private void InitializeComponent()
    {
        ...
        label3 = new Label();
        Miqdori = new Guna.UI2.WinForms.Guna2TextBox();
        label2 = new Label();
        label1 = new Label();
        ...
        label5.Location = new Point(422, 209);
        label5.Name = "label5";
        ...
        label6.Location = new Point(422, 109);
        label6.Name = "label6";
        label6.Size = new Size(113, 25);
        label6.TabIndex = 29;
        label6.Text = "Sotish Narxi";
        // 
        // Outcame_price
        // 
        ...
        Outcame_price.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
        Outcame_price.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
        Outcame_price.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
        Outcame_price.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
        Outcame_price.ForeColor = Color.Black;
        Outcame_price.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
        Outcame_price.Location = new Point(422, 134);
        Outcame_price.Margin = new Padding(4);
        Outcame_price.Name = "Outcame_price";
        ...
        Miqdori.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
        Miqdori.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
        Miqdori.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
        Miqdori.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
        Miqdori.ForeColor = Color.Black;
        Miqdori.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
        Miqdori.Location = new Point(31, 238);
        Miqdori.Margin = new Padding(4);
        Miqdori.Name = "Miqdori";
        ...
        label2.TabIndex = 25;
        label2.Text = "Yangi mahsulot kiritish";
        // 
        // label1
        // 
        ...
        label1.Location = new Point(422, 29);
        label1.Name = "label1";
        label1.Size = new Size(105, 25);
        label1.TabIndex = 24;
        label1.Text = "Olish Narxi";
        // 
        // Income_price
        // 
        ...
        Income_price.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
        Income_price.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
        Income_price.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
        Income_price.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
        Income_price.ForeColor = Color.Black;
        Income_price.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
        Income_price.Location = new Point(422, 54);
        Income_price.Margin = new Padding(4);
        Income_price.Name = "Income_price";
        ...
        Income_date.Location = new Point(422, 238);
        ...
        Save_btn.FillColor = Color.FromArgb(75, 73, 172);
        ...
        Controls.Add(label5);
        Controls.Add(label6);
        Controls.Add(Outcame_price);
        Controls.Add(label3);
        Controls.Add(Miqdori);
        Controls.Add(label1);
        Controls.Add(Income_price);
        FormBorderStyle = FormBorderStyle.FixedToolWindow;
        Name = "AddProductItemForm";
        StartPosition = FormStartPosition.CenterScreen;
        Text = "AddProductItemForm";
        Load += AddProductItemForm_Load;
        ResumeLayout(false);
        PerformLayout();
    }
    ...
    private Guna.UI2.WinForms.Guna2TextBox Outcame_price;
    private Label label3;
    private Guna.UI2.WinForms.Guna2TextBox Miqdori;
